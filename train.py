...
from misc.loss import FocalSoftTargetCrossEntropy
...
# Dataset parameters
parser.add_argument("--data_dir", metavar="DIR",default="F:\\train", help="path to dataset")
parser.add_argument(
    "--dataset",
    "-d",
    metavar="NAME",
...
parser.add_argument(
    "--lr", type=float, default=0.0001, metavar="LR", help="learning rate (default: 1e-3)"
)
parser.add_argument(
    "--lr-noise",
    type=float,
...
parser.add_argument(
    "--drop", type=float, default=0.3, metavar="PCT", help="Dropout rate (default: 0.)"
)
parser.add_argument(
    "--drop-connect",
    type=float,
...
def main():
    ...
    if args.jsd_loss:
        ...
        if args.bce_loss:
            ...
            # 假设每个类别的样本数为 samples_per_class，共有 C 类
            train_loss_fn = FocalSoftTargetCrossEntropy()
    elif args.smoothing:
        if args.bce_loss:
